 ...
 */
  $.fn.simpleColor = function(options) {
    var element = this;
    var defaultColors = [
      'cc0033','ff6600','cc3399','9900cc','000066','000099','00ffff','00ff99','330033','006633','ffff00','330000','996666',
      'ffffff','000000'
    ];
/*    var defaultColors = [
                         '990033', 'ff3366', 'cc0033', 'ff9999', 'cc3366', 'ffccff', 'cc6699',
                         '993366', '660033', 'cc3399', 'ff6699',
                         'ff66ff', 'ff33ff', 'ff00ff',
                         'cc0099', '990066', 'cc66cc', 'cc33cc', 'cc99ff', 'cc66ff', 'cc33ff', '993399',
                         'cc00cc', 'cc00ff', '9900cc', '990099', 'cc99cc', '996699', '663366', '660099',
                         '9933cc', '660066', '9900ff', '9933ff', '9966cc',
                         '6600cc', '9966ff', '330066', '6600ff', '6633ff', 'ccccff', '9999ff', '9999cc',
                         '6666cc', '6666ff', '666699', '333366', '333399', '330099',
                         '336699', '0066cc', '99ccff', '6699ff',
                         '003366', '6699cc', '006699', '3399cc', '0099cc', '66ccff', '3399ff', '003399',
                         '0099ff', '33ccff', '00ccff',
                         ...
                         '666633', '999966', 'cccc99', 'ffff99', 'ffff66', 'ffff00',
                         'ffcc00', 'ffcc66', 'ffcc33', 'cc9933', '996600', 'cc9900', 'ff9900', 'cc6600',
                         '993300', 'cc6633', '663300', 'ff9966', 'ff6633', 'ff9933', 'ff6600', 'cc3300',
                         '996633', '330000', '663333', '996666', 'cc9999', '993333', 'cc6666', 'ffcccc',
                         'ff3333', 'cc3333', 'ff6666', '660000', '990000', 'cc0000', 'ff0000', 'ff3300',
                         'cc9966', 'ffffff', 'cccccc', '999999', '666666', '333333'
                         ];
*/
    // Option defaults
    options = $.extend({
      defaultColor:     this.attr('defaultColor') || '#FFF',
      cellWidth:        this.attr('cellWidth') || 30,
      cellHeight:       this.attr('cellHeight') || 30,
